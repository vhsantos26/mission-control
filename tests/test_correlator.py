...
def test_canonical_project_preserves_hyphens_in_name(tmp_path):
    # Critical: "ump-automation" should stay "ump-automation", not become "ump/automation"
    repo = tmp_path / "ump-automation"
    repo.mkdir()
    import subprocess
    subprocess.run(["git", "init", "-q", str(repo)], check=True)
    assert canonical_project(str(repo)) == "ump-automation"
